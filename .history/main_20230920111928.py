...
class CrunchCounterApp: 
    def __init__(self, root):
        ...
        self.create_frames()
        self.current_date_label = Label(self.root, text="", font=HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR)
        self.current_date_label.place(x=500, y=700)
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        current_date_label = Label(self.get_started_frame, text="", font=HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR)
        current_date_label.place(x=500, y=700)
