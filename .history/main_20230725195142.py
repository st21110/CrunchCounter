...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        for i, label_text in enumerate(labels):
            Label(self.root, fg=FG_COLOR, font=HEADING_FONT, text=label_text, bg=BG_COLOR).grid(row=i+35, column=35)

        Label(self.root, fg=FG_COLOR, font=HEADING_FONT, text="Welcome to Crunch Counter").grid(row=1, column=1)
