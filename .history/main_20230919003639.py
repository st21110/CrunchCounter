...
class CrunchCounterApp: #create class for app
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        button_width = 370
        button_height = 100
        lunch_image = lunch_image.subsample(int(breakfast_image.width() / button_width), int(breakfast_image.height() / button_height))
        lunch_breakfast_button = Button(frame, image=breakfast_image, command=self.switch_to_logging, borderwidth=0)
        lunch_breakfast_button.image = breakfast_image 
        lunch_breakfast_button.place(x=5, y=210)
        ...
        save_breakfast_button = Button(frame, image=breakfast_image, command=self.switch_to_logging, borderwidth=0)
        save_breakfast_button.image = breakfast_image 
        save_breakfast_button.place(x=5, y=430)
