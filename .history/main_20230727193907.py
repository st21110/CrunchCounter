...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        crunch_label = Label(crunch_frame, fg=FG_COLOR, font=MAIN_HEADING_FONT, bg=BG_COLOR, text="Crunch Counter")
        ...
        disclaimer_frame.place(x=60, y=300, width=500, height=350)
        ...
        frame.place(x=700, y=100)  # Adjust the x and y coordinates to position the frame
