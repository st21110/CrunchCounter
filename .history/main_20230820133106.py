...
class CrunchCounterApp:
    ...
    def calculate(self):
        ...
        quit_button = Button(result_window, text="Quit", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=result_window.withdraw)
        quit_button.place(x=1200, y=15)
    ...
    def get_started(self, result_window):
        ...
        quit_button = Button(main_frame, text="Quit", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=home_window.withdraw)
