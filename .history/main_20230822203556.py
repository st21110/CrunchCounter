...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self): #logs meal
        ...
        caloriesint_label = Label(self.logging_frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text="Food Name: ")
        caloriesint_label.place(x=20 , y=250)

        quantity_label = Label(self.logging_frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text="Food Name: ")
        quantity_label.place(x=20 , y=290)

        save_label = Label(self.logging_frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text="Food Name: ")
        save_label.place(x=20 , y=310)
