...
class CrunchCounterApp: 
    ...
    def create_home_frame(self): #page 1 (welcome, disclaimer & user inputs)
        ...
        self.user_name_entry.place(x=160, y=40)  # Adjust x and y coordinates as needed
        ...
        age_chosen.place(x=160, y=50)  # Adjust x and y coordinates as needed

        gender_names = [("Male"), ("Female")]
        self.gender = StringVar()
        style = ttk.Style()
        style.configure("TRadiobutton", background=BG_COLOR, font="Helvetica 15")
        ttk.Radiobutton(frame, text="Male", value="Male", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=160, y=60)  # Adjust x and y coordinates as needed
        ...
        self.height_entry.place(x=160, y=70)  # Adjust x and y coordinates as needed

        self.weight_entry = EntryWithPlaceholder(frame, "kg", font=input_box_font)
        self.weight_entry.place(x=160, y=80)  # Adjust x and y coordinates as needed
