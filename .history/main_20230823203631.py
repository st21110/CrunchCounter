...
class CrunchCounterApp: #create class for app
    ...
    def initialise_donut_graph(self, total_calories):
        ...
        data = [0, total_calories]  # Initialise with 0 calories eaten
    ...
    def create_logging_frame(self): #logs meal
        ...
        get_started_button = Button(self.user_info_frame, text="Get Started ➭", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=lambda: self.switch_to_get_started(self.calorie_intake))
    ...
    def save_log(self):
        ...
        # Call switch_to_get_started and pass the calorie_intake argument
        self.switch_to_get_started(calories_left)
