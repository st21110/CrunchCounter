...
class CrunchCounterApp:
    ...
    def create_get_started_frame(self):
        ...
        data = [25, 40, 15, 20]  # Example data
        labels = ["A", "B", "C", "D"]  # Example labels
        wedges, texts, autotexts = ax.pie(data, labels=labels, autopct="%1.1f%%", startangle=90, colors=["#FF9999", "#66B3FF", "#99FF99", "#FFCC99"])
        plt.setp(autotexts, size=10, weight="bold")  # Adjust the text size
