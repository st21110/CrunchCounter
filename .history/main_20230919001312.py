...
class CrunchCounterApp: #create class for app
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        breakfast_button = Button(frame, text="Breakfast Entry ⊕", font=BUTTON_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.switch_to_logging)
        breakfast_button.place(x=20, y=220)

        dinner_button = Button(frame, text="Dinner Entry ⊕", font=BUTTON_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.switch_to_logging)
        dinner_button.place(x=20, y=320)

        snack_button = Button(frame, text="Snack Entry ⊕", font=BUTTON_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.switch_to_logging)
        snack_button.place(x=20, y=420)
