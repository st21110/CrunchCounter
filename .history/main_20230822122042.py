...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self): #logs meal
        ...
        def open_calendar_popup():
            ...
            date_label = Label(popup, text="Selected Date:", font=HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR)
            date_label.pack(pady=10)

            tkc = Calendar(popup, selectmode="day", year=2022, month=1, day=1)
            tkc.pack(pady=10)

            confirm_button = Button(popup, text="Confirm", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=confirm_date)
            confirm_button.pack()
