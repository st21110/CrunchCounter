...
HEADING_FONT = "Helvetica 35 bold"  # font size and type for headings
FG_COLOR = "aquamarine"
...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        for i, label_text in enumerate(labels):
            Label(self.root, fg=FG_COLOR, font=HEADING_FONT, text=label_text, bg=BG_COLOR).grid(row=i+20, column=35)
