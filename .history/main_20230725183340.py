...
bg=PhotoImage(file="Final (Refined) Design - CSC3.png")
...
def entrybox_text():
    ...
    def temp_text5(e): #function to delete text in entry box
        (email).delete(0,END)
    email.bind("<FocusIn>", temp_text5) #deletes the temporary text once clicked on
