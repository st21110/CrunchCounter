...
class CrunchCounterApp: 
    ...
    def create_home_frame(self): #page 1 (welcome, disclaimer & user inputs)
        ...
        ttk.Radiobutton(frame, text="Male", value="Male", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=160, y=197)  # Adjust x and y coordinates as needed
        ttk.Radiobutton(frame, text="Female", value="Female", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=250, y=197)  # Adjust x and y coordinates as needed

        self.height_entry = EntryWithPlaceholder(frame, "cm", font=input_box_font)
        self.height_entry.place(x=160, y=247)  # Adjust x and y coordinates as needed

        self.weight_entry = EntryWithPlaceholder(frame, "kg", font=input_box_font)
        self.weight_entry.place(x=160, y=297)  # Adjust x and y coordinates as needed
        ...
        activity_chosen.place(x=160, y=347)  # Adjust x and y coordinates as needed

        self.email_entry = EntryWithPlaceholder(frame, "email address", font=input_box_font)
        self.email_entry.place(x=160, y=397)  # Adjust x and y coordinates as needed
        ...
        calculate_button.place(x=160, y=447)  # Adjust x and y coordinates as needed
