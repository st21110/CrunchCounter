...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        calculate_button = Button(frame, text="Calculate !", font="Helvetica 20 bold", fg=FG_COLOR, bg="white", command=self.calculate)
        calculate_button.place(x=170, y=450)

        quit_button = Button(self.root, text="Quit", font=SMALL_FONT, fg=FG_COLOR, bg="white", command=self.quit)
    ...
    def calculate(self):
        ...
        quit_button = Button(result_window, text="Quit", font=SMALL_FONT, fg=FG_COLOR, bg="white", command=result_window.destroy)
        quit_button.place(x=1200, y=15)
        ...
        get_started_button = Button(result_window, text="Get Started ➭", font=SMALL_FONT, fg=FG_COLOR, bg="white", command=lambda: self.get_started(result_window))
