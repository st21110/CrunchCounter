...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        calculate_button = Button(frame, text="Calculate !", font="Helvetica 20 bold", fg=FG_COLOR, bg=BG_COLOR, command=lambda: self.error_check(self.calculate))
    ...
    def error_check(self, calculate_function):
        print("error check")
