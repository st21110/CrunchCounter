...
class CrunchCounterApp: #create class for app
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        logging_button = Button(frame, text="Logging", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.switch_to_logging)
        logging_button.place(x=20, y=100)
        ...
        self.calories_eaten_label.place(x=300, y=100)
        ...
        self.calories_left_label.place(x=300, y=150)
        ...
        self.calories_goal_label.place(x=300, y=200)
