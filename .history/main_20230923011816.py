...
class CrunchCounterApp: 
    ...
    def create_home_frame(self): #page 1 (welcome, disclaimer & user inputs)
        ...
        age_chosen.place(x=160, y=153)  # Adjust x and y coordinates as needed

        gender_names = [("Male"), ("Female")]
        self.gender = StringVar()
        style = ttk.Style()
        style.configure("TRadiobutton", background=BG_COLOR, font="Helvetica 15")
        ttk.Radiobutton(frame, text="Male", value="Male", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=160, y=203)  # Adjust x and y coordinates as needed
        ttk.Radiobutton(frame, text="Female", value="Female", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=250, y=203)  # Adjust x and y coordinates as needed

        self.height_entry = EntryWithPlaceholder(frame, "cm", font=input_box_font)
        self.height_entry.place(x=160, y=253)  # Adjust x and y coordinates as needed

        self.weight_entry = EntryWithPlaceholder(frame, "kg", font=input_box_font)
        self.weight_entry.place(x=160, y=303)  # Adjust x and y coordinates as needed
        ...
        activity_chosen.place(x=160, y=353)  # Adjust x and y coordinates as needed

        self.email_entry = EntryWithPlaceholder(frame, "email address", font=input_box_font)
        self.email_entry.place(x=160, y=403)  # Adjust x and y coordinates as needed
