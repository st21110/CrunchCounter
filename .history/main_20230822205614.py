...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self): #logs meal
        ...
        date_label = Label(date_frame, text="Date:", font=HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR)
        ...
        date_frame = Frame(self.logging_frame, bg=BG_COLOR, relief="groove", highlightbackground=FG_COLOR, highlightthickness=10)
        date_frame.place(x=20, y=160, width=400, height=100)

        open_calendar_button = Button(date_frame, text="Select Date", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=open_calendar_popup)
