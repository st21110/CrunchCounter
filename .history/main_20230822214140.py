...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self): #logs meal
        ...
        style = ttk.Style()
        style.configure("TCheckbutton", font=("Helvetica", 15)) 

        save_var = IntVar()
        save_checkbox = Checkbutton(self.logging_frame, fg=FG_COLOR, bg=BG_COLOR, variable=save_var, style="TCheckbutton")
