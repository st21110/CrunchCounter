...
class CrunchCounterApp: #create class for app
    ...
    def create_login_frame(self):
        ...
        users_button = Button(self.root, text="Show Existing Users", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.print_existing_users)
        users_button.grid(row=13, column=1, sticky="w", pady=10)
