...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self, meal_label_text): #logs meal
        ...
        self.food_table_label = Label(self.logging_frame, text="Common Foods", font="Helvetica 25", fg="black", bg=BG_COLOR,)
        self.food_table_label.place(x=900, y=90)

      
        self.food_table = ttk.Treeview(self.logging_frame, columns=("Food (1 serving)", "Calories (kcal)"), show="headings", height=10)
