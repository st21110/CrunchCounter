...
class CrunchCounterApp: 
    ...
    def check_and_reset_calories(self):
        ...
        last_recorded_date = load_last_recorded_date()
        ...
        if current_date > last_recorded_date:
            ...
            save_last_recorded_date(current_date)

    def load_last_recorded_date(self):
        try:
            with open(last_recorded_date_file, "rb") as file:
    ...
    def save_last_recorded_date(self, date):
        with open(last_recorded_date_file, "wb") as file:
