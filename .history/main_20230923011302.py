...
class CrunchCounterApp: 
    ...
    def create_home_frame(self): #page 1 (welcome, disclaimer & user inputs)
        ...
        for i, label_text in enumerate(labels):
            Label(frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text=label_text).place(x=15, y=90 + i * 40)  # Adjust x and y coordinates as needed

        # Entries
        self.user_name_entry = EntryWithPlaceholder(frame, "Full Name", font=input_box_font)
        self.user_name_entry.place(x=160, y=100)  # Adjust x and y coordinates as needed
        ...
        age_chosen.place(x=160, y=150)  # Adjust x and y coordinates as needed

        gender_names = [("Male"), ("Female")]
        self.gender = StringVar()
        style = ttk.Style()
        style.configure("TRadiobutton", background=BG_COLOR, font="Helvetica 15")
        ttk.Radiobutton(frame, text="Male", value="Male", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=160, y=200)  # Adjust x and y coordinates as needed
        ttk.Radiobutton(frame, text="Female", value="Female", var=self.gender, state="readonly", width=6, style="TRadiobutton").place(x=250, y=200)  # Adjust x and y coordinates as needed

        self.height_entry = EntryWithPlaceholder(frame, "cm", font=input_box_font)
        self.height_entry.place(x=160, y=250)  # Adjust x and y coordinates as needed

        self.weight_entry = EntryWithPlaceholder(frame, "kg", font=input_box_font)
        self.weight_entry.place(x=160, y=300)  # Adjust x and y coordinates as needed
        ...
        activity_chosen.place(x=160, y=350)  # Adjust x and y coordinates as needed

        self.email_entry = EntryWithPlaceholder(frame, "email address", font=input_box_font)
        self.email_entry.place(x=160, y=400)  # Adjust x and y coordinates as needed
