...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self): #logs meal
        ...
        food_entry.place(x=140, y=210, width=240)
        ...
        caloriesint_entry.place(x=140, y=250, width=240)
        ...
        quantity_entry.place(x=140, y=290, width=240)

        save_label = Label(self.logging_frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text="Save Meal? ")
        save_label.place(x=20 , y=330)

        save_var = IntVar()
        save_checkbox = Checkbutton(self.logging_frame, text="Save Meal?", font=HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR, variable=save_var)
        save_checkbox.place(x=140, y=330)
