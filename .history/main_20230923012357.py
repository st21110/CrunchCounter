...
class CrunchCounterApp: 
    ...
    def create_home_frame(self): #page 1 (welcome, disclaimer & user inputs)
        ...
        self.weight_entry.place(x=160, y=294)  # Adjust x and y coordinates as needed
        ...
        activity_chosen.place(x=160, y=344)  # Adjust x and y coordinates as needed

        self.email_entry = EntryWithPlaceholder(frame, "email address", font=input_box_font)
        self.email_entry.place(x=160, y=394)  # Adjust x and y coordinates as needed
        ...
        calculate_button.place(x=160, y=444)  # Adjust x and y coordinates as needed
