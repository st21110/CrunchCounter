...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        crunch_label.grid(sticky="w")

        line_canvas = Tk.Canvas(self.root, bg=BG_COLOR, highlightthickness=0)
        line_canvas.place(x=0, y=90, width=1400, height=5)

        # Draw the line
        line_canvas.create_line(0, 0, 1400, 0, fill=FG_COLOR)
        ...
        frame.place(x=700, y=200)  # Adjust the x and y coordinates to position the frame
