...
class CrunchCounterApp: 
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        #User logged in
        user_logged_in = Label(self.get_started_frame, text=f"Logged in as: {self.user_name_entry.get}", font=HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR)
        ...
        self.calories_eaten_label.place(x=700, y=100)
