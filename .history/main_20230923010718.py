...
class CrunchCounterApp: 
    ...
    def create_home_frame(self): #page 1 (welcome, disclaimer & user inputs)
        ...
        for i, label_text in enumerate(labels):
            Label(frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text=label_text).place(x=15, y=90 + i * 50)  # Adjust x and y coordinates as needed
        ...
        activity_chosen.place(x=160, y=200)  # Adjust x and y coordinates as needed
