...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        disclaimer_label1 = Label(disclaimer_frame, fg=FG_COLOR, font=HEADING_FONT, bg=BG_COLOR, text="Our calorie counting app is designed for informational\npurposes only and should not be considered medical advice. For personalised guidance, please consult a qualified healthcare professional or dietitian.")
