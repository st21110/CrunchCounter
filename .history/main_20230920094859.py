...
class CrunchCounterApp: 
    ...
    def create_get_started_frame(self, calorie_intake, user_data, calories_eaten):
        ...
        reset_cals = Button(self.get_started_frame, text="Reset Calories", font=SMALL_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.reset_calories(calories_eaten))
