...
class CrunchCounterApp: #create class for app
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        breakfast_button = Button(frame, text="Breakfast Entry ⊕", font=MAIN_HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.create_breakfast_frame)
        breakfast_button.place(x=20, y=150)

        dinner_button = Button(frame, text="Dinner Entry ⊕", font=MAIN_HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.create_dinner_frame)
        dinner_button.place(x=20, y=200)

        snack_button = Button(frame, text="Snack Entry ⊕", font=MAIN_HEADING_FONT, fg=FG_COLOR, bg=BG_COLOR, command=self.create_snack_frame)
