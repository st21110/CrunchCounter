...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        welcome_label.place(x=300, y=100)  # Adjust the x and y coordinates to position the label

        frame = Frame(self.root, bg=BG_COLOR, relief="groove", highlightbackground=FG_COLOR, highlightthickness=10)
        frame.place(x=600, y=300)  # Adjust the x and y coordinates to position the frame
        ...
        ttk.Button(frame, text="Quit", command=self.quit).grid(row=8, column=0, columnspan=2, pady=10)
