...
BG_COLOR = "white"
HEADING_FONT = "Helvetica 20 bold"  # font size and type for headings
...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        frame.place(x=700, y=50, width=500, height=400)  # Adjust the x and y coordinates to position the frame
