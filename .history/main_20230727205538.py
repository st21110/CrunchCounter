...
class CrunchCounterApp:
    ...
    def create_widgets(self):
        ...
        ttk.Radiobutton(frame, text="Male", value="Male", var=self.gender, state="readonly", width=30, style="TRadiobutton").grid(row=6, column=1, sticky="w")
        ttk.Radiobutton(frame, text="Female", value="Female", var=self.gender, state="readonly", width=30, style="TRadiobutton").grid(row=6, column=2, columnspan=9, sticky="w")
