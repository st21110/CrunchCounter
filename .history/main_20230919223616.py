...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self, meal_label_text): #logs meal
        ...
        if meal_label_text == "Breakfast":
            meal_image_label.place(x=360, y=90)
        elif meal_label_text == "Lunch":
            meal_image_label.place(x=230, y=90)
        elif meal_label_text == "Dinner":
            meal_image_label.place(x=100, y=90)
        elif meal_label_text == "Snack":
            meal_image_label.place(x=200, y=90)
