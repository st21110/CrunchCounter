...
class CrunchCounterApp:
    def __init__(self, root):
        ...
        self.create_widgets()
        self.bg=PhotoImage(file="./Final (Refined) Design - CSC3.png")  # background image 
        self.empty = PhotoImage()
        canvas1 = Canvas( root, width = 400,
                 height = 400)
        canvas1.grid(row=0, column= 0,columnspan=35) #fill = "both", expand = True
