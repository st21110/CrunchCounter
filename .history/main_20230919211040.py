...
class CrunchCounterApp: #create class for app
    ...
    def create_get_started_frame(self, calorie_intake, user_data):
        ...
        frame = Frame(self.get_started_frame, bg=BG_COLOR, relief="groove", highlightbackground=FG_COLOR, highlightthickness=5)
        frame.place(x=10, y=100, width=450, height= 600)

        log_cal_label = Label(frame, fg="grey", font=ALT_HEADING_FONT, bg=BG_COLOR, text="LOG CALORIES")
