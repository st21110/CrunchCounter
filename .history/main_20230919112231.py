...
class CrunchCounterApp: #create class for app
    ...
    def create_logging_frame(self): #logs meal
        ...
        open_calendar_button = Button(self.logging_frame, text="📆", font="Helvetica 20", fg="black", bg=BG_COLOR, command=open_calendar_popup)
        open_calendar_button.place(x=25, y=170)
